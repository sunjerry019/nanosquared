...
fit w(x) "../data/oscillator/data_oscillator.gnu.txt" u 1:($2/2):(0.5):(0.25) xyerror via w_0, z_0, m_sq_lmbda
...
plot w(x) title "w(z) fit" lc rgb 'dark-magenta', \
	"../data/oscillator/data_oscillator.gnu.txt" u 1:($2/2):(0.5):(0.25) w xyerrorbars title "Datapoints" pointtype 0 lc rgb 'dark-goldenrod'